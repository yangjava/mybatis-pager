 ...
 * the License.
 */
package com.mybatis.plugin.pagination;
import static com.mybatis.plugin.enums.DBType.getDBType;

import org.apache.ibatis.session.RowBounds;

import com.mybatis.plugin.exception.PagerException;
import com.mybatis.plugin.pagination.dialects.DB2Dialect;
import com.mybatis.plugin.pagination.dialects.H2Dialect;
import com.mybatis.plugin.pagination.dialects.HSQLDialect;
import com.mybatis.plugin.pagination.dialects.MySqlDialect;
import com.mybatis.plugin.pagination.dialects.OracleDialect;
import com.mybatis.plugin.pagination.dialects.PostgreDialect;
import com.mybatis.plugin.pagination.dialects.SQLServer2005Dialect;
import com.mybatis.plugin.pagination.dialects.SQLServerDialect;
import com.mybatis.plugin.pagination.dialects.SQLiteDialect;
        ...
        if (StringUtils.isNotEmpty(dialectType)) {
            ...
            if (StringUtils.isNotEmpty(dialectClazz)) {
                try {
                    ...
                    throw new PagerException("Class :" + dialectClazz + " is not found");
                }
            }
        }
        /* 未配置方言则抛出异常 */
        if (dialect == null) {
            throw new PagerException("The value of the dialect property in mybatis configuration.xml is not defined.");
        }
        return dialect;
    }
    ...
    private static IDialect getDialectByDbtype(String dbType) {
        ...
        switch (getDBType(dbType)) {
            ...
            case SQLITE:
                ...
                break;
            default:
                throw new PagerException("The Database's Not Supported! DBType:" + dbType);
        }
        return dialect;
    }
